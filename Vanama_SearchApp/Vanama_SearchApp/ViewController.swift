...
class ViewController: UIViewController {
    ...
    func imgAndTextUpdate(_ imageNumber: Int){
       if(arr == 0)
        ...
        {
            resultImage.image = UIImage(named: animals[0][imgNumber])
            topicInfoText.text = animals[1][imgNumber]
        }
        else{
            resultImage.image = UIImage(named: flowers[0][imgNumber])
            topicInfoText.text = flowers[1][imgNumber]
        }
        if(imgNumber == 0)
        {
